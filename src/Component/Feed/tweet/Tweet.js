    ...
    <div className="tweet-text">{props.data.text}</div>
        ...
        <div className="tweet-footer">
          <div className='coment'>
            <svg width="18px" height="18px" viewBox="0 0 24 24" aria-hidden="true" className="r-4qtqp9 r-yyyyoo r-1xvli5t r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-1hdv0qi">
        ...
        <div className='like' >
          ...
          <div className='share'>
            ...
            <svg
              width="18px"height="18px"viewBox="0 0 24 24"aria-hidden="true"className="r-4qtqp9 r-yyyyoo r-1xvli5t r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-1hdv0qi" >
