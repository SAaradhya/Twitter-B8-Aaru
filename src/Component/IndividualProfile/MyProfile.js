    ...
    {/* <NewTweet/> */}
        ...
        <div className='profile-header'>
            <div className='profile-back-btn'>
               <a onClick={home}> <svg height={50} width={50} viewBox="0 0 24 24" aria-hidden="true" className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-z80fyv r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-19wmn03"><g><path d="M7.414 13l5.043 5.04-1.414 1.42L3.586 12l7.457-7.46 1.414 1.42L7.414 11H21v2H7.414z"></path></g></svg></a>
            </div>
        ...
        <div className='main-cover'>
            <div className="profile-cover">
                ...
                <img  className="profile-img" src='./RJ.jpg'></img>
     ...
     <div className='profile-details-container' >
         <div className='profile-details'>
           ...
           <p className='join-date'>Joined Jan 2002</p>
           </div>

           <div className='d-flex'>
         < a href='#'> <p className='following '><b>110</b> Following</p></ a>
         < a href='#'> <p className='following '><b>12.6M</b> Followers</p></ a>
           </div>
      ...
      {  tweet.map(tweet=> <Tweet data ={tweet}/>    ) }
